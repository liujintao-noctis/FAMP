...
public:
    ...
    vtkAxesActor * orientationAxes() const { return m_orientationAxes; }
    vtkOrientationMarkerWidget * orientationMarkerWidget() const
    {
        return m_orientationMarkerWidget;
    }
...
private:
    ...
    // The orientation widget does not keep itself alive through the
    // interactor. Retain both objects for the complete viewport lifetime.
