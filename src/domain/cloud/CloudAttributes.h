...
public:
    ...
    // Builds a point-aligned subset without changing this collection. Each
    // output value is copied from the corresponding source point index.
    bool select(const QVector<qint64>& sourceIndices,
